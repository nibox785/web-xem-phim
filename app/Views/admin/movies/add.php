...
<div class="admin-container">
    ...
    <form method="POST" action="<?php echo htmlspecialchars($base_url ?? '/'); ?>index.php?action=admin_add_movie">
        <div class="form-group">
            <label for="title">Tên phim *</label>
            <input type="text" id="title" name="title" required value="<?php echo htmlspecialchars($old_data['title'] ?? ''); ?>">
        </div>
        
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="release_year">Năm phát hành *</label>
                <input type="number" id="release_year" name="release_year" min="1888" max="<?php echo date("Y") + 5; ?>" required value="<?php echo htmlspecialchars($old_data['release_year'] ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" rows="5"><?php echo htmlspecialchars($old_data['description'] ?? ''); ?></textarea>
        </div>
        
        <div class="form-group">
            <label for="poster_url">URL hình poster</label>
            <input type="url" id="poster_url" name="poster_url" value="<?php echo htmlspecialchars($old_data['poster_url'] ?? ''); ?>">
        </div>
        
        <div class="form-group">
            <label for="trailer_url">URL trailer / video phát</label>
            <input type="url" id="trailer_url" name="trailer_url" value="<?php echo htmlspecialchars($old_data['trailer_url'] ?? ''); ?>">
        </div>
