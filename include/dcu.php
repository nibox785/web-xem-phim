...
// Lấy tổng số phim DCU
$sql_total = "SELECT COUNT(*) as total FROM movies WHERE universe_id = 2";
...
$sql_marvel = "SELECT id, title, thumbnail, release_year FROM movies WHERE universe_id = 2 ORDER BY release_year DESC LIMIT ? OFFSET ?";
...
<main class="container">
    <h1 class="page-title">VŨ TRỤ DC</h1>
